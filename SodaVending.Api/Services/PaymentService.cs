...
public class PaymentService : IPaymentService
{
    ...
    //Метод для проверки, достаточно ли средств для платежа, может ли автомат выдать сдачу
    ...
    public Dictionary<int, int> CalculateChange(int changeAmount, Dictionary<int, int> availableCoins) // Используем словарь в связке ключ-значение (ключ - номинал монеты, значение - количество)
    {
